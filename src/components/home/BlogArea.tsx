          ...
          <div className="row blog-post-box align-items-center">
            ...
            <div className="col-lg-6">
              <div className="blog-post-caption">
                ...
                <h2><a className="link-decoration" href="https://in.pinterest.com/devarajts30/_created/">Social Media Creatives</a></h2>
                <a className="theme-btn theme-btn-two" href="https://in.pinterest.com/devarajts30/_created/">See more <i className="ri-arrow-right-line"></i></a>
              </div>
            </div>
          </div>
